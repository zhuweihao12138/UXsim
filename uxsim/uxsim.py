...
class Link:
    ...
    Link in a network.
    """
    def __init__(s, W, name, start_node, end_node, length, free_flow_speed=20, jam_density=0.2, jam_density_per_lane=None, number_of_lanes=2, merge_priority=1, signal_group=0, capacity_out=None, capacity_in=None, eular_dx=None, attribute=None, auto_rename=False):
        """
        Create a link
...
class World:
    ...
    def show_network(W, width=1, left_handed=1, figsize=(6,6), network_font_size=10, node_size=6):
        ...
        for n in W.NODES:
            plt.plot(n.x, n.y, "o", c="blue", ms=node_size, zorder=10)
